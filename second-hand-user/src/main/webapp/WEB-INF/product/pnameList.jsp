	...
	<div class="list-body">
		...
		<div class="list-bottom">
			<div class="content">
				...
				<c:if test="${page > 1 }">
					<a href="<c:url value='/1/${pname }/nameLikeProducts'></c:url>">首页</a>
					<a href="<c:url value='/${page-1 }/${pname }/nameLikeProducts'></c:url>">上一页</a>
				</c:if>
				<c:if test="${page < productDto.pageCount }">
					<a href="<c:url value='/${page+1 }/${pname }/nameLikeProducts'></c:url>">下一页</a>
					<a href="<c:url value='/${productDto.pageCount }/${pname }/nameLikeProducts'></c:url>">末页</a>
				</c:if>
			</div>
		</div>
	</div>
